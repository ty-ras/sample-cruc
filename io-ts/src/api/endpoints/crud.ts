...
export default [
  class {
    ...
    static async create() {
      return await sql.runSingleQuery(sql.sqlCreate, {
    ...
    static async readAll() {
      return await sql.runSingleQuery(sql.sqlReadAll, undefined);
    }
  },
  ...
  class {
    ...
    static async read({
      ...
      typeof state
    >) {
      return await sql.runSingleQuery(sql.sqlRead, { id });
    }
    ...
    @urlPathWithParameters<crud.ThingUpdate>({
      ...
      responseBody,
      state,
      requestBody: app.requestBody(t.partial(crud.data.thingWithoutID.props)),
    })
    static async update({
      url: { id },
      ...
      typeof state
    >) {
      return await sql.runSingleQuery(sql.sqlUpdate, {
        id,
        payload_string,
        payload_timestamp,
    ...
    static async delete({
      ...
      typeof state
    >) {
      return await sql.runSingleQuery(sql.sqlDelete, { id });
    }
  },
];
